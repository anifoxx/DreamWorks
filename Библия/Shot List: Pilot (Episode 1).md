...
```text
 ...
 Shot     Type / Lens                                                                              Transition
                          ...
                          of Moscow
                                                           blue
                          skyline at      Static tripod;                    Sets location and
 ...
 1        shot;                                            with warm
          ...
          35 mm                                            practical
                          ...
                          balcony                          Warm
                                          Handheld
                          railing,                         candlelight
                                          push-in                           Highlights             Cut on
          Medium          back to                          illuminates
                                          towards                           Vanessa’s              action to
 2        shot;           camera,                          her profile;
                                          Vanessa to                        vulnerability and      shot 3 as
          50 mm           looking out;                     cool city
                                          create                            anticipation.          Leo enters.
                          she holds a                      lights rim
                                          intimacy.
                          blanket                          her hair.
                          around her
                          shoulders.
                          ...
                          from
                                          follows Leo      Warm
                          apartment
                                          from door        interior light   Demonstrates
          Medium          carrying                                                                 Match cut to
                                          to railing;      spills onto      Leo’s initiative and
 3        shot;           two mugs;                                                                shot 4 for
                                          slight arc to    balcony;         establishes
          50 mm           approaches                                                               dialogue.
...
4                                    handheld         blurred
       50 mm         They face                                         share frame and      emotional
                                     sway to          bokeh
                     each other,                                       express              focus.
                                     mimic            behind
                     sipping tea,                                      micro-expressions.
                                     breathing.       them.
                     framed
                     waist-up.
```
...
Description & Blocking: Лео отвечает, глядя на неё: «Правда. Без тебя всё это — просто красивые декорации.»
...
**Шот 6c — Ванесса, тепло с мгновенной заминкой.** *(⚠️ пересмотрено: первая версия с «явной
растерянностью» на реальной генерации превратилась в устойчивую тревогу на весь шот — балкон стал
читаться так, будто Ванесса уже обижена. Тепло — доминанта кадра, заминка едва заметна и мгновенна.)*
Description & Blocking: Ванесса смотрит на него нежно; на долю секунды едва заметно сбивается, взгляд
чуть соскальзывает на город — и тут же снова тепло, затем тихо: «...Хорошо.»
...
Emotion & Purpose: Тепло и близость — с почти незаметным, мгновенным сбоем, который тут же гаснет; не
устойчивая тревога.
...
1. Composition & Framing: Establishing shots use wider lenses to situate the environment; dialogue uses 50 mm to emulate human vision; close-ups use 85 mm to draw attention to subtle expressions 1 .
...
2 How Lighting Affects Mood in Film - Mack Sennett Studios
